...
For more information on the datasets and utility functions included in the package, please see the [manual](https://github.com/Amherst-Statistics/valleybikeData/blob/master/valleybikeData_1.0.0.pdf).
